        ...
        <div className="bg-black w-full h-full flex justify-center text-white">
            <div className="w-3xl h-screen p-6 flex flex-col font-(family-name:--font-funnelsans)">
                ...
                <div className='content flex-1 px-4'>
                    <h1 className='text-4xl font-(family-name:--font-monasans) font-semibold'>
                        Hey, I'm Sobhan 👋
                    </h1>
                    ...
                    <p className='text-xl text-white/80 py-5'>
                    If you want to get in touch, I'm most responsive over <a href="mailto:sobhanghosh.jsr@gmail.com" className='text-blue-400'>email</a> and I try to be active on <a href="https://x.com/so_bhann" className='text-blue-400'>X</a> as well.
                    </p>
                </div>
                <Footer/>
            </div>
