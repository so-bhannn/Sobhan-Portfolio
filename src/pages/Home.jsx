            ...
            <div className="w-3xl p-6">
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-3 my-20">
                    <div className="w-40 h-40 border-4 border-white rounded-full overflow-hidden justify-self-center">
                        <img className="h-full w-full border-3 border-blue-400 rounded-full" src="src/assets/profile.jpg" alt="Display Picture" />
                    </div>
                    <div className="max-w-lg flex flex-wrap mx-4">
                        ...
                        <ul className="w-full flex justify-between mx-0 my-3 text-gray-400">
                            <a href="#" className="flex items-center md:gap-1">
                                <i className='bx bxl-github text-4xl md:text-2xl text-white'></i>
                                <p className="hidden hover:text-white font-semibold md:block">so-bhannn</p>
                            </a>
                            <a href="#" className="flex items-center md:gap-1">
                                <i className='bx bxl-linkedin text-4xl md:text-2xl text-blue-500'></i>
                                <p className="hidden hover:text-blue-500 font-semibold md:block">Sobhan Ghosh</p>
                            </a>
                            <a href="#" className="flex items-center md:gap-1">
                                <i className='bx bxl-twitter text-4xl md:text-2xl text-blue-300'></i>
                                <p className="hidden hover:text-blue-300 font-semibold md:block">@so_bhann</p>
                            </a>
                            <a href="#" className="flex items-center md:gap-1">
                                <i className='bx bxl-instagram text-4xl md:text-2xl text-rose-400'></i>
                                <p className="hidden hover:text-rose-400 font-semibold md:block">@so_bhann</p>
                            </a>
                        </ul>
                    </div>
                </div>
